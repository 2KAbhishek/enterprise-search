...
describe('ChatService', () => {
  ...
  describe('sendMessage', () => {
    ...
    it('should process message without MCP context when no servers connected', async () => {
      ...
      mockClaudeService.sendMessage.mockResolvedValue('I can help you with that.');
    ...
    it('should handle MCP service errors gracefully', async () => {
      mockMCPService.connectToServers.mockRejectedValue(new Error('MCP connection failed'));
      mockMCPService.getConnectedServers.mockReturnValue([]);
      mockClaudeService.sendMessage.mockResolvedValue('Sorry, I had trouble accessing your data.');
    ...
    it('should handle Claude service errors', async () => {
      mockMCPService.connectToServers.mockResolvedValue(undefined);
      mockMCPService.getConnectedServers.mockReturnValue([]);
      mockClaudeService.sendMessage.mockRejectedValue(new Error('Claude API error'));
