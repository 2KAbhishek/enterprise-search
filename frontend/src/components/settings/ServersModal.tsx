...
import {apiClient, ServersResponse} from '@/lib/api';
...
export function ServersModal({isOpen, onClose}: ServersModalProps) {
    ...
    const [serversData, setServersData] = useState<ServersResponse | null>(
        null
    );
                            ...
                            <>
                                ...
                                <div
                                    ...
                                    <p
                                        ...
                                        file. To add or modify servers, update
                                        the configuration and restart the
                                        service.
                                    </p>
                                </div>
                            </>
